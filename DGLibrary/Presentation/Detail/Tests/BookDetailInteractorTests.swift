...
final class BookDetailInteractorTests: XCTestCase {
    var sut: DefaultBookDetailInteractor!
    ...
    override func setUp() {
        ...
        sut = DefaultBookDetailInteractor(repository: repository)
    ...
    func test_fetch_성공시_presenter에게_결과_전달() async {
        ...
        sut.fetch(request: .init(isbn13: "123"))
    ...
    func test_selectPDF_presenter에게_결과_전달() {
        ...
        sut.selectPDF(request: .init(pdfURL: url))
